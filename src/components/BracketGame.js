    ...
    BracketGame.prototype.render = function () {
        ...
        var winnerBackground = (top && bottom && top.score && bottom.score && top.score.score !== bottom.score.score) ?
            (top.score.score > bottom.score.score ?
                React.createElement("rect", { x: "170", y: "12", width: "30", height: "22.5", style: { fill: winningScoreBackground }, rx: "0", ry: "0" }) :
                React.createElement("rect", { x: "170", y: "34.5", width: "30", height: "22.5", style: { fill: winningScoreBackground }, rx: "0", ry: "0" })) :
            null;
        ...
        return (React.createElement("svg", __assign({ width: "200", height: "82", viewBox: "0 0 200 82" }, rest),
            ...
            React.createElement("rect", { x: "0", y: "12", width: "200", height: "45", fill: backgroundColor, rx: "0", ry: "0" }),
            React.createElement("rect", { x: "0", y: "12", width: "200", height: "22.5", fill: topHovered ? hoverBackgroundColor : backgroundColor, rx: "0", ry: "0" }),
            React.createElement("rect", { x: "0", y: "34.5", width: "200", height: "22.5", fill: bottomHovered ? hoverBackgroundColor : backgroundColor, rx: "0", ry: "0" }),
            React.createElement("rect", { x: "170", y: "12", width: "30", height: "45", fill: scoreBackground, rx: "0", ry: "0" }),
            winnerBackground,
